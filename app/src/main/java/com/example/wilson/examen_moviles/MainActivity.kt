...
import com.example.wilson.examen_moviles.entidades.Politicas
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonProyecto.setOnClickListener{
            view: View? ->  iraActividadPoliticas()
        }
    }
    ...
    fun iraActividadPoliticas() {
        intent = Intent(this, Politicas::class.java)
        startActivity(intent)
    }
}